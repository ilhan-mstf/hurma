...
public class NodeObj {
        ...
        while (iter.hasNext()) {
            ...
            if (symbol instanceof MibValueSymbol) {
                ...
                //other objects will be kept in mibObject list
                	...
                	obj.setOid(value); //value -> 1.3.6.1.4.1.4329.2.38.3.2.1.2.1
	...
	public void setMibObjectByOid(MibValue Oid, String value){
	...
	public MIBObject getMibObjectByOid(MibValue Oid){
		for(int i = 0; i<mibObjects.size(); i++){
			if(mibObjects.get(i).getOid().equals(Oid)){
	...
	public String getMibObjectNameByOid(MibValue Oid){
		for(int i = 0; i<mibObjects.size(); i++){
			if(mibObjects.get(i).getOid().equals(Oid)){
